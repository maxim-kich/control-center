  ...
  prepare() {
    ...
    for (const extension of installed.extensions) {
      if (this.registry.extensions[extension.id]) {
        if (this.registry.extensions[extension.id].missing) {
          this.registry.extensions[extension.id].missing = false;
          this.registry.extensions[extension.id].updatedAt = new Date().toISOString();
          changed = true;
        }
        continue;
      }
